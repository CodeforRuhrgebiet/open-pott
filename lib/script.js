...
//  if(feature.properties["GN"] == "Gelsenkirchen") {
//     color = 'yellow';
//  }
...
mapLink = '<a href="https://openstreetmap.org/copyright">OpenStreetMap</a>';
usedDataLink = '<a href="https://open.nrw/dataset/opendatalandkartenrw" target="_blank">Open.NRW</a>';
githubLink = '<a href="https://github.com/CodeforRuhrgebiet/open-pott" target="_blank">auf Github</a>';

var tileLayer = L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}.{ext}', {
  attribution: 'Rohdaten von ' + usedDataLink + ' | 🗺 ' + githubLink + ' verbessern | Map tiles by <a href="https://stamen.com">Stamen Design</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; ' + mapLink,
  subdomains: 'abcd',
  minZoom: 0,
  maxZoom: 20,
  ext: 'png'
...
info.update = function (props) {
  var text = '<h4>Open Data Verf&uumlgbarkeit 2017</h4>';
...
fetch('./map-data.json', function (data) {
